  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="image/brian.jpg" width=100 height=100 alt="Sunny Prakash Tiwari" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<a style="color:#202020; font-family:'typo' ; font-size:18px; text-decoration:none" title="Find on Facebook">Hirwa Alain Brian</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+250784571544</h4>
		<h4 style="font-family:'typo' ">hirwabrian9@gmail.com</h4>
		<h4 style="font-family:'typo' ">UK</h4></div></div>
		</p>
      </div>
